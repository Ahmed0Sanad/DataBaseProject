...
namespace DataAccessLayer.Data.Migrations
{
    ...
    [Migration("20241220204227_updateOfferedPrimary02")]
    partial class updateOfferedPrimary02
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InstructorOfferedCourse", b =>
                {
                    ...
                    b.HasKey("InstructorsId", "OfferedCoursesCourseId");

                    b.HasIndex("OfferedCoursesCourseId");
            ...
            modelBuilder.Entity("InstructorOfferedCourse", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Models.OfferedCourse", null)
                        .WithMany()
                        .HasForeignKey("OfferedCoursesCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
