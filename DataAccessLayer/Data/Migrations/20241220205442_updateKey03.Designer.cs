...
namespace DataAccessLayer.Data.Migrations
{
    ...
    [Migration("20241220205442_updateKey03")]
    partial class updateKey03
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Enroll", b =>
                {
                    ...
                    b.Property<int>("OfferedCourseYear")
                        .HasColumnType("int");

                    b.HasKey("StudentId", "OfferedCourseId");

                    b.HasIndex("OfferedCourseCourseId", "OfferedCourseYear");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Enroll", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Models.OfferedCourse", "OfferedCourse")
                        .WithMany("StudentCourses")
                        .HasForeignKey("OfferedCourseCourseId", "OfferedCourseYear")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
