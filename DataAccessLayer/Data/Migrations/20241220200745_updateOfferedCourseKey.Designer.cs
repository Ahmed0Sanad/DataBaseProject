...
namespace DataAccessLayer.Data.Migrations
{
    ...
    [Migration("20241220200745_updateOfferedCourseKey")]
    partial class updateOfferedCourseKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Enroll", b =>
                {
                    ...
                    b.Property<int>("OfferedCourseClassRoom")
                        .HasColumnType("int");

                    b.Property<TimeOnly>("OfferedCourseTime")
                        .HasColumnType("time");

                    b.HasKey("StudentId", "OfferedCourseId");

                    b.HasIndex("OfferedCourseClassRoom", "OfferedCourseTime");
            ...
            modelBuilder.Entity("InstructorOfferedCourse", b =>
                {
                    ...
                    b.Property<int>("OfferedCoursesClassRoom")
                        .HasColumnType("int");

                    b.Property<TimeOnly>("OfferedCoursesTime")
                        .HasColumnType("time");

                    b.HasKey("InstructorsId", "OfferedCoursesClassRoom", "OfferedCoursesTime");

                    b.HasIndex("OfferedCoursesClassRoom", "OfferedCoursesTime");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Enroll", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Models.OfferedCourse", "OfferedCourse")
                        .WithMany("StudentCourses")
                        .HasForeignKey("OfferedCourseClassRoom", "OfferedCourseTime")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InstructorOfferedCourse", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Models.OfferedCourse", null)
                        .WithMany()
                        .HasForeignKey("OfferedCoursesClassRoom", "OfferedCoursesTime")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
